...
public @interface MyAnnotation { // 골뱅이인터페이스
...
/*
 * 여러 줄 주석 - 소스 코드에 여러 줄의 설명을 붙일 때 사용 - 컴파일 할 때 .class 파일에 포함되지 않음
 */

/**
 * javadoc 주석 - javadoc.exe 를 통해 HTML API 문서를 생성할 때 사용됨. - 컴파일 할 때 .class 파일에 포함되지 않음
 */
