package com.eomcs.oop.ex02.test02;
// 데이터 타입 정의
// 11) 클래스 사용전: <<OK>>
// - 낱개 변수 사용
// 12) 성적 데이터를 저장할 메모리를 새로 정의: <<OK>>
...
import com.eomcs.oop.ex02.test02.vo.Score;

public class Test {
  public static void main(String[] args) {

    Score s1 = new Score("홍1동", 38, 83, 31);
    Score s2 = new Score("홍2동", 23, 14, 23);
