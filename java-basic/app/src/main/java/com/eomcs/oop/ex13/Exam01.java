...
public class Exam01 {
  ...
  static void init() throws Exception {
    ...
    props.forEach((Object key, Object value) -> System.out.printf("%s = %s\n", key, value));
    // forEach 쓰면 타입에 상관없이 반복문을 돌릴 수 있는 장점이 있다. (중복코드 감소)

    label = new Properties();
    label.load(
        new FileReader(String.format("%s-%s_%s.properties", filename, userLanguage, userCountry)));
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(label.get("byebye"));
