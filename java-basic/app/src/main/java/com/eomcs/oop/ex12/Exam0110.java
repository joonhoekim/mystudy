...
public class Exam0110 {
  ...
  // 익명 클래스도 항상 생성자가 호출되며 슈퍼클래스의 기본생성자를 호출한다.
  interface Player {
    void play();
  }
  ...
  public static void main(String[] args) {
    ...
    Player p3 = () -> {
      System.out.println("ImadeThis");
    };

    Player p4 = () -> {
      System.out.println("lksldkjflksfjd");
    };
    ...
    Player p1 = new Player() {
      // 슈퍼클래스에 별도의 생성자가 없으므로 기본생성자만 호출이 가능하다.
      @Override
      public void play() {
    ...
    // => 뻔한 코드 생략!
    Player p21 = () -> System.out.println("익명 클래스");
    p21.play();

    Player p22 = () -> System.out.println("LAMBDAEXPRESSION");
    Player p23 = () -> System.out.println("ThokThangHae");
    Player p24 = () -> System.out.println("hi");
    Player p25 = () -> System.out.println(Hello);
    Player p123 = new Player() {
      @Override
      public void play() {
        System.out.println("HELLO");
      }
    };
    Player p124 = () -> System.out.println("Hello");
    Player lambda = () -> System.out.println("This is 람다문법이야");
